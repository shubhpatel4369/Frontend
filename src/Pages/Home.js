                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="index.html"><div class="logo">
                                        <img src="asset/img/Travel Diary logo.png" alt="Travel Diary Logo" />
                                    </div></a>
                                    <nav id="primary-nav" class="dropdown cf">
                                        <ul class="dropdown menu">
                                            ...
                                            <li><Link class="scrollTo" data-scrollTo="planning" to="/Home/TripplanUpdate">Trip Planning</Link></li>
                                            <li><Link class="scrollTo" data-scrollTo="diary" to="/Home/TraveldiaryUpdate">Travel Diary</Link></li>
                                            <li><Link class="scrollTo" data-scrollTo="contact" to="/Home/UserUpdate">Contact Us</Link></li>
                                            <li><Link class="scrollTo" data-scrollTo="Role" to="/Home/RoleUpdate">Role assign</Link></li>
                                            <li><Link class="scrollTo" data-scrollTo="Role" to="/Home/HotelUpdate">Hotel</Link></li>
                                            {/* <li><Link class="scrollTo" data-scrollTo="Dashboard" to="/Home/AdminDashboard">AdminDashboard</Link></li> */}
                                            <li><Link class="scrollTo" data-scrollTo="logout" to="/">Logout</Link></li>
                                        </ul>
                                    </nav>{/* <!-- / #primary-nav --> */}
                                    {localStorage.getItem('user-info') ?
                                        <Nav>
                                            <Link to={'/'}> <NavDropdown title={user && user.name}>
                                                <NavDropdown.Item onClick={logout}>Logout</NavDropdown.Item></NavDropdown></Link>
                                        </Nav>
                                        : null
                                    }
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="banner-caption">
                                    ...
                                    <span>Always arrange best trips for yours </span>
                                    <div class="blue-button">
                                        <Link class="scrollTo" data-scrollTo="popular" to="">Discover More</Link>
                                    </div>
                                </div>
                                    ...
                                    <form id="form-submit" action="" method="get">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 third-item">
                                                <fieldset>
                                                    <select required name='category' onchange='this.form.submit()'>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="about-veno">
                                    <div class="logo">
                                        <img src="asset/img/travel logo.png" alt="Venue Logo" />
                                    </div>
