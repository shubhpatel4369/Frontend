...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" to="assets/images/favicon.ico" type="image/x-icon">
    <!-- fontawesome icon -->
    <link rel="stylesheet" to="assets/fonts/fontawesome/css/fontawesome-all.min.css">
    <!-- animation css -->
    <link rel="stylesheet" to="assets/plugins/animation/css/animate.min.css">
    <!-- vendor css -->
    <link rel="stylesheet" to="assets/css/style.css">
...
<body> */}
            ...
            <nav class="pcoded-navbar">
                <div class="navbar-wrapper">
                    <div class="navbar-brand header-logo">
                        <Link to="index.html" class="b-brand">
                            <div class="b-bg">
                                <i class="feather icon-trending-up"></i>
                            </div>
                            <span class="b-title">Travel Diary</span>
                        </Link>
                        <Link class="mobile-menu" id="mobile-collapse" to="javascript:"><span></span></Link>
                    </div>
                    <div class="navbar-content scroll-div">
                        <ul class="nav pcoded-inner-navbar">
                            ...
                            <li data-username="dashboard Default Ecommerce CRM Analytics Crypto Project" class="nav-item active">
                                <Link to="/AdminDashboard/RoleUpdate" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Dashboard</span></Link>
                            </li>
                            <li class="nav-item pcoded-menu-caption">
                                <label>UI Element</label>
                            </li>
                            <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                                <Link to="/AdminDashboard/StateUpdate" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Components</span></Link>
                                <ul class="pcoded-submenu">
                                    {/* <li class="ScrollTo"><Link to="/AdminDashboard/Component/RoleUpdate" class="">Role</Link></li> */}
                                    {/* <li class="ScrollTo"><Link to="/AdminDashboard/UserUpdate" class="">User</Link></li> */}
                                    {/* <li class="ScrollTo"><Link to="/AdminDashboard/Components/CountryUpdate" class="">Country</Link></li> */}
                                    <li class="ScrollTo"><Link to="/AdminDashboard/StateUpdate" class=""></Link></li>
                                    {/* <li class=""><Link to="bc_collapse.html" class="">Collapse</Link></li> */}
                                    {/* <li class=""><Link to="bc_tabs.html" class="">Tabs & pills</Link></li> */}
                                    {/* <li class=""><Link to="bc_typography.html" class="">Typography</Link></li> */}


                                    <li class=""><Link to="icon-feather.html" class="">Feather<span class="pcoded-badge label label-danger">NEW</span></Link></li>
                                </ul>
                            </li>
                            <li class="nav-item pcoded-menu-caption">
                            ...
                            <li data-username="form elements advance componant validation masking wizard picker select" class="nav-item">
                                <Link to="/AdminDashboard/CityUpdate" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Form elements</span></Link>
                            </li>
                            <li data-username="Table bootstrap datatable footable" class="nav-item">
                                <Link to="/AdminDashboard/Traveldiary" class="nav-link "><span class="pcoded-micon"><i class="feather icon-server"></i></span><span class="pcoded-mtext">Table</span></Link>
                            </li>
                            <li class="nav-item pcoded-menu-caption">
                                <label>Chart & Maps</label>
                            </li>
                            <li data-username="Charts Morris" class="nav-item"><Link to="chart-morris.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-pie-chart"></i></span><span class="pcoded-mtext">Chart</span></Link></li>
                            <li data-username="Maps Google" class="nav-item"><Link to="map-google.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-map"></i></span><span class="pcoded-mtext">Maps</span></Link></li>
                            <li class="nav-item pcoded-menu-caption">
                                <label>Pages</label>
                            </li>
                            <li data-username="Authentication Sign up Sign in reset password Change password Personal information profile settings map form subscribe" class="nav-item pcoded-hasmenu">
                                <Link to="javascript:" class="nav-link "><span class="pcoded-micon"><i class="feather icon-lock"></i></span><span class="pcoded-mtext">Authentication</span></Link>
                                <ul class="pcoded-submenu">
                                    <li class=""><Link to="auth-signup.html" class="" target="_blank">Sign up</Link></li>
                                    <li class=""><Link to="auth-signin.html" class="" target="_blank">Sign in</Link></li>
                                </ul>
                            </li>
                            <li data-username="Sample Page" class="nav-item"><Link to="/AdminDashboard/CountryUpdate" class="nav-link"><span class="pcoded-micon"><i class="feather icon-sidebar"></i></span><span class="pcoded-mtext">Country</span></Link></li>
                            <li data-username="Disabled Menu" class="nav-item disabled"><Link to="/" class="nav-link"><span class="pcoded-micon"><i class="feather icon-power"></i></span><span class="pcoded-mtext">Disabled menu</span></Link></li>
                        </ul>
                    </div>
                </div>
            </nav>
            ...
            <header class="navbar pcoded-header navbar-expand-lg navbar-light">
                <div class="m-header">
                    <Link class="mobile-menu" id="mobile-collapse1" to="javascript:"><span></span></Link>
                    <Link to="index.html" class="b-brand">
                        <div class="b-bg">
                            <i class="feather icon-trending-up"></i>
                        </div>
                ...
                <Link class="mobile-menu" id="mobile-header" to="javascript:">
                    <i class="feather icon-more-horizontal"></i>
                </Link>
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav mr-auto">
                        <li><Link to="javascript:" class="full-screen" onclick="javascript:toggleFullScreen()"><i class="feather icon-maximize"></i></Link></li>
                        <li class="nav-item dropdown">
                            <Link class="dropdown-toggle" to="javascript:" data-toggle="dropdown">Dropdown</Link>
                            <ul class="dropdown-menu">
                                <li><Link class="dropdown-item" to="javascript:">Action</Link></li>
                                <li><Link class="dropdown-item" to="javascript:">Another action</Link></li>
                                <li><Link class="dropdown-item" to="javascript:">Something else here</Link></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <div class="main-search">
                                <div class="input-group">
                                    ...
                                    <Link to="javascript:" class="input-group-append search-close">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li>
                            <div class="dropdown">
                                <Link class="dropdown-toggle" to="javascript:" data-toggle="dropdown"><i class="icon feather icon-bell"></i></Link>
                                <div class="dropdown-menu dropdown-menu-right notification">
                                    <div class="noti-head">
                                        <h6 class="d-inline-block m-b-0">Notifications</h6>
                                        <div class="float-right">
                                            <Link to="javascript:" class="m-r-10">mark as read</Link>
                                            <Link to="javascript:">clear all</Link>
                                        </div>
                                    </div>
                                    <ul class="noti-body">
                                        <li class="n-title">
                                    ...
                                    <div class="noti-footer">
                                        <Link to="javascript:">show all</Link>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="dropdown drp-user">
                                <Link to="javascript:" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right profile-notification">
                                    <div class="pro-head">
                                        ...
                                        <span>John Doe</span>
                                        <Link to="auth-signin.html" class="dud-logout" title="Logout">
                                            <i class="feather icon-log-out"></i>
                                        </Link>
                                    </div>
                                    <ul class="pro-body">
                                        <li><Link to="javascript:" class="dropdown-item"><i class="feather icon-settings"></i> Settings</Link></li>
                                        <li><Link to="javascript:" class="dropdown-item"><i class="feather icon-user"></i> Profile</Link></li>
                                        <li><Link to="message.html" class="dropdown-item"><i class="feather icon-mail"></i> My Messages</Link></li>
                                        <li><Link to="auth-signin.html" class="dropdown-item"><i class="feather icon-lock"></i> Lock Screen</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                                                        ...
                                                        <table class="table table-hover">
                                                            <tbody>
                                                                <tr class="unread">
                                                                    ...
                                                                    <td><Link to="#!" class="label theme-bg2 text-white f-12">Reject</Link><Link to="#!" class="label theme-bg text-white f-12">Approve</Link></td>
                                                                </tr>
                                                                <tr class="unread">
                                ...
                                <!-- [ rating list ] starts--> */}
                                        ...
                                        <div class="col-xl-8 col-md-12 m-b-30">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <Link class="nav-link" id="home-tab" data-toggle="tab" to="#home" role="tab" aria-controls="home" aria-selected="false">Today</Link>
                                                </li>
                                                <li class="nav-item">
                                                    <Link class="nav-link active show" id="profile-tab" data-toggle="tab" to="#profile" role="tab" aria-controls="profile" aria-selected="true">This Week</Link>
                                                </li>
                                                <li class="nav-item">
                                                    <Link class="nav-link" id="contact-tab" data-toggle="tab" to="#contact" role="tab" aria-controls="contact" aria-selected="false">All</Link>
                                                </li>
                                            </ul>
                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="text-right"><i class="fas fa-circle text-c-green f-10" aria-hidden="true"></i></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right"><i class="fas fa-circle text-c-red f-10" aria-hidden="true"></i></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right"><i class="fas fa-circle text-c-purple f-10" aria-hidden="true"></i></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <h6 class="m-0"><img class="rounded-circle  m-r-10" style={{width:"40px"}} src="assets/images/user/avatar-1.jpg" alt="activity-user" />Ida Jorgensen</h6>
            ...
            {/* <div class="ie-warning">
                ...
                <div class="iew-container">
                    <ul class="iew-download">
                        <li>
                            <Link to="http://www.google.com/chrome/">
                                <img src="assets/images/browser/chrome.png" alt="Chrome" />
                                <div>Chrome</div>
                            </Link>
                        </li>
                        <li>
                            <Link to="https://www.mozilla.org/en-US/firefox/new/">
                                <img src="assets/images/browser/firefox.png" alt="Firefox" />
                                <div>Firefox</div>
                            </Link>
                        </li>
                        <li>
                            <Link to="http://www.opera.com">
                                <img src="assets/images/browser/opera.png" alt="Opera" />
                                <div>Opera</div>
                            </Link>
                        </li>
                        <li>
                            <Link to="https://www.apple.com/safari/">
                                <img src="assets/images/browser/safari.png" alt="Safari" />
                                <div>Safari</div>
                            </Link>
                        </li>
                        <li>
                            <Link to="http://windows.microsoft.com/en-us/internet-explorer/download-ie">
